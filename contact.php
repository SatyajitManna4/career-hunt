...
<?php include('include/header.php'); ?>
	...
	<div class="main">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="page-header-content text-black pt-4">
                            ...
                            <h3 class="text-black mb-0 text-black font-32 text-uppercase">Contact Us</h3>
        ...
        <section id="contact" class="contact-us-section bg-white-f9 ptb-40">
            ...
            <div class="container">
                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-md-12 col-lg-5 mb-5 mb-md-5 mb-sm-5 mb-lg-0">
                        ...
                        <div class="contact-us-form bg-white border-1px rounded p-5">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact" placeholder="Enter contact number" required="required">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="message" id="message" class="form-control" rows="4" cols="25" placeholder="Message"></textarea>
                    ...
                    <div class="col-md-12 col-lg-6">
                        ...
                        <div class="contact-us-content">
                            ...
                            <h4 class="font-25 mb-0 line-height-40">You can reach out to us 24*7 on the given contact details. We will get in touch with you at the earliest.</h4>
