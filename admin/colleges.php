...
if(empty($userid)){
 ...
 if(!empty($_GET['deleterecord'])){
	...
	$sql = "DELETE FROM colleges WHERE id=".$_GET['deleterecord']."";
...
<?php include('topbar.php');?>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Institutes</h6> 
				<a href="add-college.php" class="btn btn-primary" >Add Institute</a>
                  ...
                  <table id="dataTableExample" class="table">
                    <thead>
                     ...
                     <tbody id="after12_row">
                            <?php
							$upesdata = runloopQuery("select * from colleges  order by ID desc");
                            if(!empty($upesdata)){
                            $x=1; foreach($upesdata as $allctse){	?>

                            <tr id="recordid<?php echo $allctse['ID'];?>">
                                <td><?php echo $x;?></td> 
                                <td><a href="javascript:void(0);"  onclick="landingpage(<?php echo $allctse->id;?>);"><?php echo $allctse['name'];?></a></td>
                                ...
                                <td>
								<a  class="btn btn-success btn-sm"   href="edit-college.php?edit=<?php echo $allctse['id'];?>"><i class="fa fa-pencil mr-0-5"></i>Edit</a>
