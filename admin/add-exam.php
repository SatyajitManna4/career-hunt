...
if(empty($userid)){
 ...
 if(!empty($_POST['examsubmit'])){
	...
	$prevcolle = runQuery("select * from exam where exam_name = '".$examlug."'");
	...
	$result = insertQuery($collegearray,'exam');
	
if (!$result) {
   
header("Location: add-exam.php?success=success");
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
					<div class="col-md-12">
						<label>Name: </label>
						<input type="text" class="form-control" required name="exam_name" />
					</div> 
					<div class="col-md-12">
						<label>Application Link: </label>
						<input type="text" class="form-control" required name="application_link" />
					</div> 
					<div class="col-md-12">
