...
<?php include('include/header.php'); ?>
    ...
    <div class="main">
		...
		<?php  $singleschool = !empty($_REQUEST['slug'])?runQuery( "select * from  school where slug = '" . $_REQUEST['slug'] . "'" ):""; ?> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header-content text-black pt-4 text-center">
                            <h3 class="text-black mb-0 text-black font-32 text-uppercase">List of Top <?=!empty($singleschool)?$singleschool['school_name']:"";?> colleges in India</h3>
                        </div>
                    </div>
                </div>
            </div>    
                    ...
                    <div class="col-12">
                        <div class="custom-breadcrumb">
                            <ol class="breadcrumb pl-0 mb-0 bg-transparent">
                                ...
                                <li class="breadcrumb-item active">List of Top <?=$singleschool['school_name']?> colleges in India</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <section class="promo-section pt-30 pb-30">
            <div class="container-fluid">
				...
				<?php 
					...
					$collegesarray = !empty($singleschool)?runloopQuery("select * from colleges where FIND_IN_SET(".$singleschool['school_id'].", school) "):runloopQuery("select * from colleges");
